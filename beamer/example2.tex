\documentclass[first=dgreen,second=purple,logo=keltainenHuuto]{aaltoslides}
...
\date{Version 1.01, 31.1.2011 / \today}
...
\begin{frame}{Testaus}
\begin{itemize}
\item Kirjoita \texttt{pdflatex example2}
\item Muokkaa logovalintoja (kieli, väri, ! ? ``) tiedostossa \texttt{aaltoslides.cls}
\end{itemize}
\end{frame}
