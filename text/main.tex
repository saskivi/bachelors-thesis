...
\TITLE{Videonauhoitteiden alku- ja lopputekstien paikannus\\ katsomistilastojen perusteella}
...
\KEYWORDS{muutospisteiden havaitseminen, segmentaatio,\\ tilastollinen signaalinkäsittely, NPVR, käyttäytymisanalytiikka}
\ENKEYWORDS{change point detection, segmentation,\\ statistical signal processing, NPVR, behavioural analytics}
...
\PAGES{27} %TODO: tähän kokonaissivumäärä
