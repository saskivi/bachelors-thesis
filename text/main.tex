...
\title{Video change point detection based on viewing statistics}
%\title{Utilisation of viewing statistics to detect change points in NPVR}
% 2-osainen otsikko:
...
\TITLE{Lopputekstien paikannus NPVR tallenteesta katsomistilastoja hyödyntäen}
%\TITLE{\LaTeX{} för kandidatseminariet med jättelång rubrik som fortsätter och
% fortsätter ännu}
\ENTITLE{Utilisation of viewing statistics in detecting NPVR closing credits}
...
\KEYWORDS{muutospisteiden havaitseminen, }
\ENKEYWORDS{change point detection, }
